          ...
          if (item === null) {
            return (
              <button
                key="capture"
                onClick={openCapture}
                className="w-11 h-11 rounded-2xl bg-orange text-white flex items-center justify-center shadow-lg shadow-orange/30 active:scale-95 transition-transform -translate-y-2"
              >
